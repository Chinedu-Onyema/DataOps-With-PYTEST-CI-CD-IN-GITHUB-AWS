...
import numpy as np
import pytest
from transform_auction import (read_url_table, clean_url_column, clean_condition_column, clean_vin_column, clean_transmission_column, clean_mileage_column, clean_fuel_type_column, clean_the_overall_table, clean_the_price_column)
...
def test_clean_the_overall_table(simulated_data_structure):
    ...
    expected_columns = [
        ...
        'Condition', 'Transmission_Type', 'Fuel_Type'
    ]
